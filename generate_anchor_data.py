...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default="alpaca", help="dataset")
    ...
    if args.dataset == "code":
        ...
        with open(data_path) as f:
            data = json.load(f)
        query_list = [alpaca_data_reg['instruction']+' '+alpaca_data_reg['input'] for alpaca_data_reg in data]


    OUTPUT_DIR = "./anchor_data/{}_{}_no_wm.json".format(args.model_name, args.dataset)
